...
Plugin URI:		https://development.azurecurve.co.uk/classicpress-plugins/disable-floc/
Download link:	https://github.com/azurecurve/Disable-FLoC/releases/download/1.1.1/codepotent-disable-floc.zip
 ...
 * Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/disable-floc/releases/latest/).
...
### [Version 1.1.1](https://github.com/azurecurve/Disable-FLoC/releases/1.1.1/)
